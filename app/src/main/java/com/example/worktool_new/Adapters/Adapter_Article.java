...
public class Adapter_Article extends RecyclerView.Adapter<Adapter_Article.ViewHolder> {
    private Context context;
    private ArrayList<ArticlesModel.Datum> datamodelArraylist;

    public Adapter_Article(Context context2, ArrayList<ArticlesModel.Datum> datamodelArraylist2) {
        this.context = context2;
        this.datamodelArraylist = datamodelArraylist2;
    }

    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(this.context).inflate(R.layout.item_article, parent, false));
    }
    ...
    public int getItemCount() {
        ArrayList<ArticlesModel.Datum> arrayList = this.datamodelArraylist;
        if (arrayList == null) {
            return 0;
        }
